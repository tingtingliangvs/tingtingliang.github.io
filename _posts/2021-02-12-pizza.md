...
Pizza is commonly baked on stone. Steel, however, has a higher heat capacity and a lower heat resistance than stone.
That means it stores more energy at the same temperature, and transmits it to the pizza faster. Baking on steel
has been proposed by multiple other articles and videos \[1,2,3\] and *baking-steels* are available as a commercial product
...
Salt is not only important for flavor, it also enhances the dough's strength. XYZ discuss the chemical effects of salt 
in dough making in detail, while XYY compare different doughs and observe a higher *extensibility* in dough 
with added salt.
